...
cp $PROJECT_BASE_PATH/softforest-rest-api/deploy/supervisor_softforest.conf /etc/supervisor/conf.d/softforest.conf
supervisorctl reread
supervisorctl update
supervisorctl restart softforest

# Setup nginx to make our application accessible.
cp $PROJECT_BASE_PATH/softforest-rest-api/deploy/nginx_softforest.conf /etc/nginx/sites-available/softforest.conf
